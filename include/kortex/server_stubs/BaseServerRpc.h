...
class BaseServer : public KeApiService
{
	public:
		...
		virtual Kinova::Api::Error GetControlMode(const KeApiRouter::tSessionInfo &sessionInfo, Kinova::Api::Common::Empty* pInEmpty, Kinova::Api::Base::ControlModeInformation* pOutControlModeInformation);
		...
		virtual Kinova::Api::Error GetAllJointsSpeedHardLimitation(const KeApiRouter::tSessionInfo &sessionInfo, Kinova::Api::Common::Empty* pInEmpty, Kinova::Api::Base::JointsLimitationsList* pOutJointsLimitationsList);
		...
		virtual Kinova::Api::Error GetTwistHardLimitation(const KeApiRouter::tSessionInfo &sessionInfo, Kinova::Api::Common::Empty* pInEmpty, Kinova::Api::Base::TwistLimitation* pOutTwistLimitation);
		...
		virtual Kinova::Api::Error GetAllJointsSpeedSoftLimitation(const KeApiRouter::tSessionInfo &sessionInfo, Kinova::Api::Common::Empty* pInEmpty, Kinova::Api::Base::JointsLimitationsList* pOutJointsLimitationsList);
		...
		virtual Kinova::Api::Error GetTwistSoftLimitation(const KeApiRouter::tSessionInfo &sessionInfo, Kinova::Api::Common::Empty* pInEmpty, Kinova::Api::Base::TwistLimitation* pOutTwistLimitation);
		...
		void NotifyControlModeTopic(Kinova::Api::Base::ControlModeNotification& controlModeNotification);
	...
	private:
		...
		ReturnStatus cbGetAllJointsSpeedHardLimitation(const KeApiRouter::tSessionInfo &sessionInfo, std::string* pInOutpayload);
		ReturnStatus cbGetAllJointsTorqueHardLimitation(const KeApiRouter::tSessionInfo &sessionInfo, std::string* pInOutpayload);
		ReturnStatus cbGetTwistHardLimitation(const KeApiRouter::tSessionInfo &sessionInfo, std::string* pInOutpayload);
		...
		ReturnStatus cbGetAllJointsSpeedSoftLimitation(const KeApiRouter::tSessionInfo &sessionInfo, std::string* pInOutpayload);
		ReturnStatus cbGetAllJointsTorqueSoftLimitation(const KeApiRouter::tSessionInfo &sessionInfo, std::string* pInOutpayload);
		ReturnStatus cbGetTwistSoftLimitation(const KeApiRouter::tSessionInfo &sessionInfo, std::string* pInOutpayload);
